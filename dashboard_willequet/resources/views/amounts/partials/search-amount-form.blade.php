<div class="pt-2 relative mx-auto w-1/4 text-gray-600 self-end	">
  <form class="flex items-center" action="{{ route('amounts.search') }}" method="GET">  
    @csrf
